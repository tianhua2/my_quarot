...
def main():
    ...
    model = model_utils.get_model(args.model, 
                                  ...
                                  args.score_coeff, args.TH_H, args.TH_L, args.CACHE_SIZE,args.TH_H2, args.TH_L2, args.TH_H3, args.TH_L3, args.TH_H4, args.TH_L4, 
                                  args.hf_token)
    model.eval()
    ...
    if args.w_bits < 16:
        ...
        if args.load_qmodel_path: # Load Quantized Rotated Model
            ...
            assert ("llama" in args.model) or ("mistral" in args.model) or ("qwen" in args.model), "Only llama or mistral or qwen is supported for GPTQ!"
    ...
    results = lm_eval.simple_evaluate(hflm, tasks=task_names, batch_size=args.lm_eval_batch_size, limit=0.4)['results']
    print(results)
