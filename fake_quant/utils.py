...
def parser_gen():
    ...
    parser.add_argument('--rotate_mode', type=str, default='hadamard', choices=['hadamard', 'random', 'sparse_hadamard'])
    ...
    parser.add_argument('--KV_BITS4', type=int, default=4)
    ...
    parser.add_argument('--TH_H2', type=float, default=0.)
    parser.add_argument('--TH_L2', type=float, default=0.) 
    parser.add_argument('--TH_H3', type=float, default=0.)
    parser.add_argument('--TH_L3', type=float, default=0.) 
    parser.add_argument('--TH_H4', type=float, default=0.)
    parser.add_argument('--TH_L4', type=float, default=0.)         
